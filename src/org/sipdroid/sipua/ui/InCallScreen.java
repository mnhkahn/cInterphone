...
//	    sensorManager.registerListener(this,proximitySensor,SensorManager.SENSOR_DELAY_NORMAL);
	...
	public void onPause() {
		super.onPause();
    	if (!CInterphone.release) Log.i("SipUA:","on pause");
	...
	public void onResume() {
		super.onResume();
    	if (!CInterphone.release) Log.i("SipUA:","on resume");
		switch (Receiver.call_state) {
		case UserAgent.UA_STATE_INCOMING_CALL:
			if (Receiver.pstn_state == null || Receiver.pstn_state.equals("IDLE"))
				if (PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.cyeam.cInterphone.ui.Settings.PREF_AUTO_ON, com.cyeam.cInterphone.ui.Settings.DEFAULT_AUTO_ON) &&
						!mKeyguardManager.inKeyguardRestrictedInputMode())
					mHandler.sendEmptyMessageDelayed(MSG_ANSWER, 1000);
				else if ((PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.cyeam.cInterphone.ui.Settings.PREF_AUTO_ONDEMAND, com.cyeam.cInterphone.ui.Settings.DEFAULT_AUTO_ONDEMAND) &&
						PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.cyeam.cInterphone.ui.Settings.PREF_AUTO_DEMAND, com.cyeam.cInterphone.ui.Settings.DEFAULT_AUTO_DEMAND)) ||
						(PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(com.cyeam.cInterphone.ui.Settings.PREF_AUTO_HEADSET, com.cyeam.cInterphone.ui.Settings.DEFAULT_AUTO_HEADSET) &&
								Receiver.headset > 0))
	        ...
	        (t = new Thread() {
				public void run() {
					...
					if (Settings.System.getInt(getContentResolver(),
						...
						tg = new ToneGenerator(AudioManager.STREAM_VOICE_CALL, (int)(ToneGenerator.MAX_VOLUME*2*com.cyeam.cInterphone.ui.Settings.getEarGain()));
					for (;;) {
						if (!running) {
							t = null;
							break;
