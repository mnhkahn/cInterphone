...
{   
    ...
    protected void onSaveRingtone(Uri ringtoneUri) 
    {
		...
		edit.putString(com.cyeam.cInterphone.ui.Settings.PREF_SIPRINGTONE, ringtoneUri != null ? ringtoneUri.toString() : com.cyeam.cInterphone.ui.Settings.DEFAULT_SIPRINGTONE);		
		edit.commit();        
    }
    ...
    {
        String uriString = PreferenceManager.getDefaultSharedPreferences(mContext).getString(com.cyeam.cInterphone.ui.Settings.PREF_SIPRINGTONE,
