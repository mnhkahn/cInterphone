...
public class VideoCamera extends CallScreen implements 
    ...
    public void onStart() {
        ...
        videoQualityHigh = PreferenceManager.getDefaultSharedPreferences(mContext).getString(com.cyeam.cInterphone.ui.Settings.PREF_VQUALITY, com.cyeam.cInterphone.ui.Settings.DEFAULT_VQUALITY).equals("high");
    ...
    public void onResume() {
        ...
        if (!justplay) {
			...
			try {
				...
				if (!CInterphone.release) e1.printStackTrace();
				super.onResume();
				finish();
				return;
			}
	        ...
	        startVideoRecording();
        } else if (Receiver.engine(mContext).getRemoteVideo() != 0 && PreferenceManager.getDefaultSharedPreferences(this).getString(com.cyeam.cInterphone.ui.Settings.PREF_SERVER, com.cyeam.cInterphone.ui.Settings.DEFAULT_SERVER).equals(com.cyeam.cInterphone.ui.Settings.DEFAULT_SERVER)) {
